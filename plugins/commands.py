...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/kishori661"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/kishori66"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/updating1')
            ],[
             InlineKeyboardButton('🙆🏻 Help 🦾', callback_data='help'),
            InlineKeyboardButton('♥️ About ♥️', callback_data='about')
        ],[
            InlineKeyboardButton('Hollywood', url='https://t.me/radheradhe765'),
            InlineKeyboardButton('Bollywood', url='https://t.me/radheradhe765'),
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('JOIN GROUP', url='https://t.me/radheradhe765')],
        [InlineKeyboardButton('SUBSCRIBE', url='https://youtube.com/@DK_Gamer006'),
        InlineKeyboardButton('Auth USERS', url='https://t.me/MGRadhradh77777')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
